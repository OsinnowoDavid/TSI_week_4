...
import { addcourse,getCourseById, updatecourse, deletecourse, getcourses ,enroll_course} from "../controllers/coursecontroller.js"
...
courseroutes.get("/getcoursebtid/:id",authorizationRole('student'), getCourseById)
